...
- [x] **T-001** [P] [infra] **Monorepo scaffold** — cluster: Foundation | deps: — | | parallel: ✓ | effort: XS
...
- **T-002** [P] [backend] **Backend pyproject.toml with pinned deps** — cluster: Foundation | deps: — | | parallel: ✓ | effort: S
...
- **T-075** [test] **LLMProvider protocol contract tests** — cluster: US-2 | deps: T-002 | FR-009 | parallel: ✓ | effort: S
...
- **T-076** [backend] **LLMProvider protocol** — cluster: US-2 | deps: T-075 | FR-009 | parallel: ✗ | effort: XS
...
- **T-077** [test] **AnthropicAdapter unit test** — cluster: US-2 | deps: T-076 | FR-009 | parallel: ✓ | effort: S
...
- **T-078** [backend] **AnthropicAdapter** — cluster: US-2 | deps: T-077,T-076 | FR-009 | parallel: ✗ | effort: S
...
- **T-079** [test] **OpenAIAdapter unit test** — cluster: US-2 | deps: T-076 | FR-009 | parallel: ✓ | effort: S
...
- **T-080** [backend] **OpenAIAdapter** — cluster: US-2 | deps: T-079,T-076 | FR-009 | parallel: ✗ | effort: S
...
- **T-081** [test] **GeminiAdapter unit test** — cluster: US-2 | deps: T-076 | FR-009 | parallel: ✓ | effort: S
...
- **T-082** [backend] **GeminiAdapter** — cluster: US-2 | deps: T-081,T-076 | FR-009 | parallel: ✗ | effort: S
...
- **T-083** [test] **OllamaAdapter unit test** — cluster: US-2 | deps: T-076 | FR-009 | parallel: ✓ | effort: S
...
- **T-084** [backend] **OllamaAdapter** — cluster: US-2 | deps: T-083,T-076 | FR-009 | parallel: ✗ | effort: S
...
- **T-085** [test] **LLM factory selection test** — cluster: US-2 | deps: T-078,T-080,T-082,T-084 | FR-009,FR-026,SC-008 | parallel: ✗ | effort: S
...
- **T-086** [backend] **LLM factory** — cluster: US-2 | deps: T-085 | FR-009,FR-026 | parallel: ✗ | effort: XS
...
- **T-087** [backend] **Prompt builder** — cluster: US-2 | deps: T-076 | FR-008 | parallel: ✓ | effort: S
...
- **T-088** [test] **EvaluatorRule protocol + pipeline tests** — cluster: US-2 | deps: T-002 | FR-010,FR-011 | parallel: ✓ | effort: S
...
- **T-089** [backend] **Evaluator base + pipeline** — cluster: US-2 | deps: T-088 | FR-010,FR-011 | parallel: ✗ | effort: S
...
- **T-090** [test] **ReadOnlyRule unit tests** — cluster: US-2 | deps: T-089 | FR-010,SC-003 | parallel: ✓ | effort: M
...
- **T-091** [backend] **ReadOnlyRule** — cluster: US-2 | deps: T-090 | FR-010,SC-003 | parallel: ✗ | effort: S
...
- **T-092** [test] **SingleStatementRule unit tests** — cluster: US-2 | deps: T-089 | FR-010 | parallel: ✓ | effort: S
...
- **T-093** [backend] **SingleStatementRule** — cluster: US-2 | deps: T-092 | FR-010 | parallel: ✗ | effort: XS
...
- **T-094** [test] **SchemaValidationRule unit tests** — cluster: US-2 | deps: T-089 | FR-010,SC-004 | parallel: ✓ | effort: M
...
- **T-095** [backend] **SchemaValidationRule** — cluster: US-2 | deps: T-094 | FR-010,SC-004 | parallel: ✗ | effort: M
...
- **T-096** [test] **UnsafePatternRule unit tests** — cluster: US-2 | deps: T-089 | FR-010 | parallel: ✓ | effort: S
...
- **T-097** [backend] **UnsafePatternRule** — cluster: US-2 | deps: T-096 | FR-010 | parallel: ✗ | effort: S
...
- **T-098** [backend] **SchemaContext model** — cluster: US-2 | deps: T-089 | FR-008,FR-010 | parallel: ✓ | effort: S
...
- **T-099** [test] **SchemaIntrospector unit tests** — cluster: US-2 | deps: T-017 | FR-008 | parallel: ✓ | effort: S
...
- **T-100** [backend] **SchemaIntrospector** — cluster: US-2 | deps: T-099,T-098 | FR-008 | parallel: ✗ | effort: M
...
- **T-101** [test] **SchemaTokenLimitExceeded test** — cluster: US-2 | deps: T-100 | | parallel: ✗ | effort: S
...
- **T-102** [backend] **Schema token limit escalation** — cluster: US-2 | deps: T-101,T-100 | | parallel: ✗ | effort: S
...
- **T-103** [test] **SourceDBConnector read-only test** — cluster: US-2 | deps: T-017 | FR-005,FR-013 | parallel: ✓ | effort: S
...
- **T-104** [backend] **SourceDBConnector** — cluster: US-2 | deps: T-103,T-009 | FR-005,FR-013 | parallel: ✗ | effort: S
...
- **T-105** [test] **SourceDBExecutor timeout test** — cluster: US-2 | deps: T-104 | FR-012,FR-013,SC-011 | parallel: ✗ | effort: S
...
- **T-106** [backend] **SourceDBExecutor** — cluster: US-2 | deps: T-105,T-104 | FR-012,FR-013,SC-011 | parallel: ✗ | effort: M
...
- **T-107** [test] **Redis processing lock tests** — cluster: US-2 | deps: T-014 | FR-030 | parallel: ✓ | effort: S
...
- **T-108** [backend] **Redis processing lock** — cluster: US-2 | deps: T-107,T-014 | FR-030 | parallel: ✗ | effort: S
...
- **T-109** [test] **Ephemeral attempt storage tests** — cluster: US-2 | deps: T-014 | | parallel: ✓ | effort: S
...
- **T-110** [backend] **Ephemeral attempt store** — cluster: US-2 | deps: T-109,T-014 | | parallel: ✗ | effort: S
...
- **T-111** [test] **QueryService reject tests** — cluster: US-2 | deps: T-017,T-110 | FR-017,FR-018,FR-020,SC-005,SC-012 | parallel: ✓ | effort: M
...
- **T-112** [test] **QueryService regenerate tests** — cluster: US-2 | deps: T-017,T-110 | FR-019,SC-005 | parallel: ✓ | effort: S
...
- **T-114** [test] **Reject router integration test** — cluster: US-2 | deps: T-113,T-013 | FR-017,FR-018 | parallel: ✓ | effort: S
...
- **T-115** [backend] **Reject router** — cluster: US-2 | deps: T-114,T-113,T-039 | FR-017,FR-018 | parallel: ✗ | effort: S
...
- **T-116** [test] **Regenerate router integration test** — cluster: US-2 | deps: T-113,T-013 | FR-019 | parallel: ✓ | effort: S
...
- **T-117** [backend] **Regenerate router** — cluster: US-2 | deps: T-116,T-113,T-039 | FR-019 | parallel: ✗ | effort: XS
...
- **T-118** [test] **Admin refresh-schema router integration test** — cluster: US-2 | deps: T-100,T-013 | | parallel: ✓ | effort: S
...
- **T-119** [backend] **Admin refresh-schema router** — cluster: US-2 | deps: T-118,T-100 | | parallel: ✗ | effort: S
...
- **T-120** [test] **Invariant 1: Evaluator gate — no DB contact on eval failure** — cluster: US-2 | deps: T-113 | SC-002 | parallel: ✓ | effort: S
...
- **T-121** [test] **Invariant 3: No concurrent submissions** — cluster: US-2 | deps: T-108,T-113 | FR-030 | parallel: ✓ | effort: S
...
- **T-122** [test] **Invariant 5: Read-only source DB** — cluster: US-2 | deps: T-104 | FR-005 | parallel: ✓ | effort: S
...
- **T-123** [test] **Invariant 6: Ephemeral attempt ownership** — cluster: US-2 | deps: T-110 | | parallel: ✓ | effort: S
...
- **T-124** [test] **Schemathesis contract: /query/submit** — cluster: US-2 | deps: T-058 | SC-002 | parallel: ✗ | effort: S
...
- **T-125** [test] **Schemathesis contract: /query/reject, /query/regenerate** — cluster: US-2 | deps: T-115,T-117 | FR-017,FR-019 | parallel: ✗ | effort: S
...
- **T-126** [test] **Schemathesis contract: /admin/refresh-schema** — cluster: US-2 | deps: T-119 | | parallel: ✓ | effort: XS
...
- **T-127** [test] **Custom exceptions test** — cluster: US-2 | deps: T-002 | | parallel: ✓ | effort: XS
...
- **T-128** [backend] **Custom exceptions module** — cluster: US-2 | deps: T-127 | | parallel: ✗ | effort: XS
...
- **T-129** [frontend] **Regenerate OpenAPI client for US-2 endpoints** — cluster: US-2 | deps: T-061,T-115,T-117,T-119 | FR-017,FR-019 | parallel: ✗ | effort: XS
...
- **T-130** [test] **MSW handlers for /query/submit success, evaluator rejection, timeout, 409, 502** — cluster: US-2 | deps: T-025,T-129 | FR-007,FR-014,FR-017,FR-028,FR-030 | parallel: ✓ | effort: S
...
- **T-131** [test] **useSubmitQuestion hook RTL tests** — cluster: US-2 | deps: T-130 | FR-006,FR-007,FR-014,FR-017,FR-019,FR-030 | parallel: ✓ | effort: M
...
- **T-137** [test] **EvaluatorRejectionBanner RTL tests** — cluster: US-2 | deps: T-025 | FR-028,SC-009 | parallel: ✓ | effort: XS
...
- **T-138** [frontend] **EvaluatorRejectionBanner component** — cluster: US-2 | deps: T-137,T-022 | FR-028,SC-009 | parallel: ✗ | effort: XS
...
- **T-139** [test] **RefinePromptBanner RTL tests** — cluster: US-2 | deps: T-025 | FR-018,SC-009 | parallel: ✓ | effort: XS
...
- **T-140** [frontend] **RefinePromptBanner component** — cluster: US-2 | deps: T-139,T-022 | FR-018,SC-009 | parallel: ✗ | effort: XS
...
- **T-141** [test] **TimeoutBanner RTL tests** — cluster: US-2 | deps: T-025 | FR-012,SC-009 | parallel: ✓ | effort: XS
...
- **T-145** [test] **i18n key verification — no inline string literals** — cluster: US-2 | deps: T-022,T-144 | SC-009 | parallel: ✗ | effort: S
...
- **T-146** [test] **E2E: reject → auto-retry → new result → accept** — cluster: US-2 | deps: T-028,T-144,T-115 | FR-017,FR-018,SC-005 | parallel: ✗ | effort: L
...
- **T-147** [test] **E2E: double-reject → refine prompt → new question resets counter** — cluster: US-2 | deps: T-028,T-144,T-115 | FR-018,FR-019,SC-005 | parallel: ✗ | effort: M
...
- **T-148** [test] **E2E: evaluator rejection + timeout + concurrent error rendering** — cluster: US-2 | deps: T-028,T-144 | FR-012,FR-028,FR-030 | parallel: ✗ | effort: M
...
- **T-149** [test] **Acceptance: data-modifying SQL blocked via submit pipeline** — cluster: US-3 | deps: T-058,T-091 | FR-010,SC-002,SC-003 | parallel: ✓ | effort: M
...
- **T-150** [test] **Acceptance: schema-invalid SQL blocked via submit pipeline** — cluster: US-3 | deps: T-058,T-095 | FR-010,SC-004 | parallel: ✓ | effort: S
...
- **T-151** [test] **Acceptance: multi-statement SQL blocked via submit pipeline** — cluster: US-3 | deps: T-058,T-093 | FR-010 | parallel: ✓ | effort: XS
...
- **T-152** [test] **Acceptance: valid read-only SELECT and CTE pass evaluator** — cluster: US-3 | deps: T-058,T-089,T-106 | FR-010,FR-013 | parallel: ✓ | effort: S
...
- **T-153** [test] **Acceptance: query timeout cancellation and cleanup** — cluster: US-3 | deps: T-058,T-106 | FR-012,SC-011 | parallel: ✓ | effort: S
...
- **T-154** [test] **Evaluator extensibility: custom rule registration** — cluster: US-3 | deps: T-089 | FR-011 | parallel: ✓ | effort: S
...
- **T-155** [test] **EvaluatorRejectionBanner violation-type differentiation** — cluster: US-3 | deps: T-130,T-138 | FR-028,SC-009 | parallel: ✓ | effort: S
...
- **T-156** [test] **E2E: evaluator blocks unsafe SQL — full acceptance sweep** — cluster: US-3 | deps: T-028,T-144,T-058 | FR-010,FR-028,SC-002,SC-003,SC-004 | parallel: ✗ | effort: L
...
- **T-157** [test] **E2E: timeout displays message and writes no history** — cluster: US-3 | deps: T-028,T-144,T-058 | FR-012,SC-011 | parallel: ✗ | effort: S
...
- **T-158** [test] **Invariant 2: accept-only persistence — reject/regenerate write nothing** — cluster: US-4 | deps: T-113,T-047 | SC-012 | parallel: ✓ | effort: S
...
- **T-159** [test] **Invariant 4: byte-equal duplicate detection emits RefinePrompt** — cluster: US-4 | deps: T-113 | SC-005 | parallel: ✓ | effort: S
...
- **T-160** [test] **Invariant 6: cross-session ephemeral attempt ownership** — cluster: US-4 | deps: T-110 | | parallel: ✓ | effort: S
...
- **T-161** [test] **Schemathesis contract: /history, /history/{id}** — cluster: US-4 | deps: T-060 | FR-021,FR-023 | parallel: ✓ | effort: S
...
- **T-161b** [test] **HistoryListResponse.total first-page-only contract** — cluster: US-4 | deps: T-060 | FR-021 | parallel: ✓ | effort: XS
...
- **T-162** [test] **useHistory hook RTL tests** — cluster: US-4 | deps: T-025,T-061 | FR-021,FR-023 | parallel: ✓ | effort: S
...
- **T-163** [frontend] **useHistory hook** — cluster: US-4 | deps: T-162,T-024,T-061 | FR-021,FR-022,FR-023 | parallel: ✗ | effort: S
...
- **T-164** [test] **HistoryList component RTL tests** — cluster: US-4 | deps: T-025,T-163 | FR-021,FR-022,SC-006,SC-007,SC-009 | parallel: ✓ | effort: M
...
- **T-165** [frontend] **HistoryList component** — cluster: US-4 | deps: T-164,T-163,T-022 | FR-021,FR-022,SC-006,SC-007,SC-009 | parallel: ✗ | effort: M
...
- **T-166** [test] **HistoryDetail component RTL tests** — cluster: US-4 | deps: T-025,T-163 | FR-023,SC-009 | parallel: ✓ | effort: S
...
- **T-167** [frontend] **HistoryDetail component** — cluster: US-4 | deps: T-166,T-163,T-022 | FR-023,SC-009 | parallel: ✗ | effort: S
...
- **T-168** [test] **HistoryPage integration tests** — cluster: US-4 | deps: T-025,T-165,T-167 | FR-021,FR-022,FR-023,SC-009 | parallel: ✗ | effort: M
...
- **T-169** [frontend] **HistoryPage assembly** — cluster: US-4 | deps: T-168,T-165,T-167,T-023 | FR-021,FR-022,FR-023,SC-009 | parallel: ✗ | effort: M
...
- **T-170** [test] **useSubmitQuestion kind discriminator integration test** — cluster: US-4 | deps: T-130,T-132 | FR-017,FR-019 | parallel: ✓ | effort: S
...
- **T-171** [test] **E2E: history list, reverse-chrono order, filter, detail** — cluster: US-4 | deps: T-028,T-169,T-060 | FR-021,FR-022,FR-023,SC-006,SC-007 | parallel: ✗ | effort: L
...
- **T-172** [test] **E2E: empty history state** — cluster: US-4 | deps: T-028,T-169 | FR-021 | parallel: ✗ | effort: S
...
- **T-173** [test] **E2E: rejected queries absent from history** — cluster: US-4 | deps: T-028,T-169,T-115 | FR-020,SC-012 | parallel: ✗ | effort: M
...
- **T-174** [test] **Acceptance: provider switch preserves accepted_queries** — cluster: US-5 | deps: T-086,T-047,T-052 | FR-026,SC-008 | parallel: ✓ | effort: M
...
- **T-175** [test] **Acceptance: invalid LLM_PROVIDER fails at startup** — cluster: US-5 | deps: T-007,T-086 | FR-009,SC-008 | parallel: ✓ | effort: XS
...
- **T-176** [test] **Acceptance: Ollama-exclusive routing — no cloud API contact** — cluster: US-5 | deps: T-084,T-086,T-052 | FR-009 | parallel: ✓ | effort: S
...
- **T-177** [test] **Acceptance: reconfigured provider handles new questions** — cluster: US-5 | deps: T-086,T-052 | FR-009,FR-026 | parallel: ✓ | effort: S
...
- **T-178** [test] **E2E: deploy with provider A → accept queries → switch to provider B → old history + new query** — cluster: US-5 | deps: T-028,T-169,T-086 | FR-009,FR-026,SC-008 | parallel: ✗ | effort: L
...
- **T-179** [test] **ESLint no-inline-strings: full codebase sweep** — cluster: US-6 | deps: T-019,T-144,T-169 | FR-024,SC-009 | parallel: ✓ | effort: S
...
- **T-180** [test] **Stylelint logical-properties: full codebase sweep** — cluster: US-6 | deps: T-020,T-144,T-169 | FR-025,SC-010 | parallel: ✓ | effort: S
...
- **T-181** [test] **Tailwind output contains no physical-direction utilities** — cluster: US-6 | deps: T-021 | FR-025,SC-010 | parallel: ✓ | effort: XS
...
- **T-182** [test] **en.json key completeness: every t() call has a key, every key is used** — cluster: US-6 | deps: T-022,T-144,T-169 | FR-024,SC-009 | parallel: ✓ | effort: S
...
- **T-184** [test] **Backend error responses use message_key from en.json** — cluster: US-6 | deps: T-128,T-022 | FR-024 | parallel: ✓ | effort: S
...
- **T-185** [test] **E2E: no missing-key placeholders across all pages** — cluster: US-6 | deps: T-028,T-144,T-169 | FR-024,SC-009 | parallel: ✗ | effort: M
...
- **T-186** [test] **E2E: no physical-direction CSS in rendered pages** — cluster: US-6 | deps: T-028,T-144,T-169 | FR-025,SC-010 | parallel: ✗ | effort: S
...
- **T-187** [infra] **Backend coverage gate: pytest-cov + CI threshold** — cluster: Polish | deps: T-058,T-115,T-128 | | parallel: ✓ | effort: S
...
- **T-188** [infra] **Frontend coverage gate: Vitest coverage + CI threshold** — cluster: Polish | deps: T-145,T-169,T-186 | | parallel: ✓ | effort: S
...
- **T-189** [infra] **Unified CI workflow: lint → typecheck → test → build → contract → e2e** — cluster: Polish | deps: T-187,T-188 | | parallel: ✗ | effort: M
...
- **T-190** [test] **SC coverage suite: SC-001..SC-012 mapped to assertions** — cluster: Polish | deps: T-074,T-148,T-156,T-157,T-171,T-173,T-178,T-185,T-186 | SC-001,SC-002,SC-003,SC-004,SC-005,SC-006,SC-007,SC-008,SC-009,SC-010,SC-011,SC-012 | parallel: ✗ | effort: M
...
- **T-191** [test] **Performance-budget verification** — cluster: Polish | deps: T-074,T-171 | SC-001,SC-006,SC-007,SC-011 | parallel: ✗ | effort: M
...
- **T-192** [docs] **quickstart.md verified on a fresh machine** — cluster: Polish | deps: T-189 | | parallel: ✓ | effort: S
...
- **T-193** [docs] **Operator runbook** — cluster: Polish | deps: T-189 | | parallel: ✓ | effort: M
