...
class TestQueryServiceReject:
    ...
    async def test_reject_calls_llm_with_negative_context(self, service, mock_deps, lifecycle_aware):
        ...
        with (
            ...
            result = await service.reject_query("a1", "s1", USER_ID)
    ...
    async def test_reject_raises_on_cross_session(self, service, mock_deps):
        ...
        with (
            ...
            await service.reject_query("a1", "s2", USER_ID)
    ...
    async def test_reject_raises_on_missing_attempt(self, service, mock_deps):
        ...
        with (
            ...
            await service.reject_query("missing", "s1", USER_ID)
    ...
    async def test_reject_acquires_and_releases_lock(self, service, mock_deps):
        ...
        with (
            ...
            await service.reject_query("a1", "s1", USER_ID)
