...
class TestUserConnectionsEndpoint:
    ...
    async def test_list_user_connections_empty(self):
        ...
        mock_service.list_user_available = AsyncMock(return_value=[])
        ...
        app.dependency_overrides[
            getattr(__import__("app.api.v1.connections", fromlist=["_get_connection_service"]), "_get_connection_service")
        ] = override_service
        app.dependency_overrides[
            getattr(__import__("app.core.dependencies", fromlist=["require_active_user"]), "require_active_user")
        ] = override_user
    ...
    async def test_list_user_connections_filters_unhealthy(self):
        ...
        from app.schemas.connection import UserConnectionResponse
        from app.services.connection_service import ConnectionService
