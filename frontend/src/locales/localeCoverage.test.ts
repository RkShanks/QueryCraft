...
describe('Wave 14 i18n key coverage', () => {
  const requiredKeys = [
    ...
    // CHUNK-15 unsaved role-policy preview
    'admin.roles.preview.title',
    'admin.roles.preview.description',
    'admin.roles.preview.noExecution',
    'admin.roles.preview.question',
    'admin.roles.preview.sampleSql',
    'admin.roles.preview.test',
    'admin.roles.preview.retry',
    'admin.roles.preview.state.empty',
    'admin.roles.preview.state.loading',
    'admin.roles.preview.state.allowed',
    'admin.roles.preview.state.blocked',
    'admin.roles.preview.state.invalid',
    'admin.roles.preview.state.retry',
    'admin.roles.preview.state.permission-denied',
    'admin.roles.preview.state.stale',
    'admin.roles.preview.accessibleTables',
    'admin.roles.preview.blockedTables',
    'admin.roles.preview.accessibleColumns',
    'admin.roles.preview.filters',
    'admin.roles.preview.masks',
    'admin.roles.preview.none',
