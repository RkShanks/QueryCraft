...
`IS-GAP-036` is resolved on tested product commit `bbb7d3421a07eb04c0866acc47a87fa6c6e9f1a2`; its focused PR and authoritative CI are pending. Its [CHUNK-16 evidence](evidence/chunk-16-role-mapping-recovery.md) records one-transaction role/policy/mapping/audit persistence, duplicate/conflict/audit/commit rollback, exactly one winner under same-group concurrency, omitted/empty/no-op mapping semantics, exact audit counts, one composite role write and zero standalone mapping writes per Save, authoritative lost-response reconciliation, preserved drafts, 64-operation parity, complete local gates, and responsive EN/AR Chromium proof.
...
These decisions block only `CHUNK-30` and `CHUNK-31`. `CHUNK-15 / IS-GAP-024 / IS-GAP-026 / IS-GAP-035` is merged at `c92255de4e0be0fde59b3f0bf3045b7115de7354`. `CHUNK-16 / IS-GAP-036` is resolved on tested product commit `bbb7d3421a07eb04c0866acc47a87fa6c6e9f1a2`; local atomicity, recovery, browser, complete frontend/backend and cleanup gates passed. Its focused PR, authoritative CI and squash merge remain the `CHUNK-17` dispatch gate.
