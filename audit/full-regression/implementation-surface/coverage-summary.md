...
These decisions block only `CHUNK-30` and `CHUNK-31`. All product chunks through `CHUNK-21` are now merged or awaiting this PR's CI and squash merge; `CHUNK-20` merged as `48f775834a9c2c1fa3f4c2ea95132c1ff287d119` via [#318](https://github.com/RkShanks/QueryCraft/pull/318).
