...
These decisions block only `CHUNK-30` and `CHUNK-31`. `CHUNK-11` is resolved on tested branch commit `00b5ad8f266d7f6156a5c3ce6ed11b59c54f5652`, and authoritative backend/frontend CI passed on `f17bf48ba7a829a1f77aea374de2fe7276491c6c`; merge remains the `CHUNK-12` dispatch gate. No CHUNK-12 work has started.
