...
- `CHUNK-07` / `IS-GAP-023` + `IS-GAP-025` + `IS-GAP-022`: **Resolved** on tested product commit `3d2f05a6046ed1bd9f6b2a461fedd2c7f82b10db`; PR/CI pending. See the [Markdown](evidence/chunk-07-ui-identity-permissions.md) and [JSON](evidence/chunk-07-ui-identity-permissions.json) identity-generation, cache-isolation, exact permission matrix, role round-trip, live expiry/re-login and cleanup evidence. `CHUNK-08` remains gated until merge.
