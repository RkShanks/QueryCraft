...
- `CHUNK-10` / `IS-GAP-017` + `IS-GAP-013`: **Resolved on the tested branch** at product commit `3b6f90dd938d51bef9e04ba4f5a57afce3335b68`; authoritative backend/frontend CI is pending. See the [Markdown](evidence/chunk-10-data-invariants.md) and [JSON](evidence/chunk-10-data-invariants.json) named PostgreSQL constraints, atomic refusal/repair, downgrade/re-upgrade, concurrent singleton, fail-closed consumer, API-only recovery and cleanup evidence. Squash merge remains the `CHUNK-11` dispatch gate.
