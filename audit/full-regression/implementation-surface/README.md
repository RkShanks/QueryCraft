...
- `CHUNK-09` / `IS-GAP-014`: **Resolved on the tested branch** at product commit `dca6ed77ab6e16a762a0c0f5a2d4286b9f58ba51` in [#307](https://github.com/RkShanks/QueryCraft/pull/307). See the [Markdown](evidence/chunk-09-quota-partial-success.md) and [JSON](evidence/chunk-09-quota-partial-success.json) fail-closed transition, idempotent PUT/DELETE recovery, audit/timestamp/counter, cross-worker, PostgreSQL/Redis fault, EN/AR browser and cleanup evidence. Authoritative backend/frontend CI and squash merge remain the `CHUNK-10` dispatch gate.
