...
- `CHUNK-08` / `IS-GAP-020`: **Resolved** on tested product commit `1a11980ad3e395bf3b65131b1d5e6ce0209a19b5` in [#306](https://github.com/RkShanks/QueryCraft/pull/306); authoritative backend/frontend CI is pending and required before merge. See the [Markdown](evidence/chunk-08-prompt-length.md) and [JSON](evidence/chunk-08-prompt-length.json) configured-limit discovery/enforcement, cross-runtime Unicode boundary, fail-closed prompt, browser/API, no-side-effect and cleanup evidence. `CHUNK-09` remains blocked until CI-passed squash merge.
