...
- `CHUNK-08` / `IS-GAP-020`: **Resolved** on tested product commit `1a11980ad3e395bf3b65131b1d5e6ce0209a19b5` in [#306](https://github.com/RkShanks/QueryCraft/pull/306); authoritative backend/frontend CI passed on `48ad094d8b95480aa87110c4a477b63533217bd0`. See the [Markdown](evidence/chunk-08-prompt-length.md) and [JSON](evidence/chunk-08-prompt-length.json) configured-limit discovery/enforcement, cross-runtime Unicode boundary, fail-closed prompt, browser/API, no-side-effect and cleanup evidence. `CHUNK-09` remains blocked until squash merge.
- `CHUNK-09` / `IS-GAP-014`: **Resolved on the tested branch** at product commit `dca6ed77ab6e16a762a0c0f5a2d4286b9f58ba51` in [#307](https://github.com/RkShanks/QueryCraft/pull/307); authoritative backend/frontend CI passed on `42df59fe56e1dbebc6485b10c4ba96d936973454`. See the [Markdown](evidence/chunk-09-quota-partial-success.md) and [JSON](evidence/chunk-09-quota-partial-success.json) fail-closed transition, idempotent PUT/DELETE recovery, audit/timestamp/counter, cross-worker, PostgreSQL/Redis fault, EN/AR browser and cleanup evidence. Squash merge remains the `CHUNK-10` dispatch gate.
