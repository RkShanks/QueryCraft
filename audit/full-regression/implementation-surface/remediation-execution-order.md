...
`CHUNK-01` through `CHUNK-23` are resolved and merged. `CHUNK-24` executed its deterministic closure and classified all live-provider smokes Setup-dependent, leaving IS-GAP-015 Partial pending an approved provider environment; `CHUNK-25` is the next unblocked dispatch. Decision-gated CHUNK-30/31 remain blocked until their explicit decisions are recorded.
