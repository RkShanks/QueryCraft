...
`CHUNK-01` through `CHUNK-23` are resolved and merged. `CHUNK-24` is the next unblocked dispatch; no CHUNK-24 work has started. Decision-gated CHUNK-30/31 remain blocked until their explicit decisions are recorded.
